...
public class IntRange extends Range<Integer> {
   ...
   */
  public static IntRange createFromString(@Nullable String spec) throws IllegalArgumentException {
    if (spec == null)
  ...
  public static IntRange of(Object o) throws IllegalArgumentException {
    return switch (o) {
      case null -> throw new IllegalArgumentException("Cannot build IntRange from null");
      case CharSequence string -> createFromString(string.toString());
      case Number number ->
          new IntRange(Collections.singletonList(new Restriction<>(number.intValue(), true, number.intValue(), true)));
      default -> throw new IllegalArgumentException("Cannot build IntRange from " + o);
    };
