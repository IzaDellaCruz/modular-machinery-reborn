...
public class JeiDurabilityPerTickComponent extends JeiComponent<ItemStack, RecipeRequirement<DurabilityComponent,
    RequirementDurabilityPerTick, IOInventory>> {
  private final List<ItemStack> items;
  public JeiDurabilityPerTickComponent(RecipeRequirement<DurabilityComponent, RequirementDurabilityPerTick, IOInventory> requirement) {
