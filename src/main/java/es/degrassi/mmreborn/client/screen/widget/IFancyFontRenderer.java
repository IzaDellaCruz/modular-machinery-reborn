...
public interface IFancyFontRenderer {
  ...
  default void drawTitleText(GuiGraphics graphics, Component text, int y) {
    drawScrollingString(graphics, text, 0, y, IFancyFontRenderer.TextAlignment.CENTER, titleTextColor(), 4, false);
  }

  default void drawTitleTextTextWithOffset(GuiGraphics graphics, Component text, int x, int y, int end) {
    drawTitleTextTextWithOffset(graphics, text, x, y, end, 4, IFancyFontRenderer.TextAlignment.CENTER);
  }

  default void drawTitleTextTextWithOffset(GuiGraphics graphics, Component text, int x, int y, int end, int maxLengthPad, IFancyFontRenderer.TextAlignment alignment) {
    drawScrollingString(graphics, text, x, y, alignment, titleTextColor(), end - x, maxLengthPad, false);
  }

  default void drawScrollingString(GuiGraphics graphics, Component text, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int maxLengthPad, boolean shadow) {
    drawScrollingString(graphics, text, x, y, alignment, color, maxLengthPad, shadow, getTimeOpened());
  }

  default void drawScrollingString(GuiGraphics graphics, Component text, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int maxLengthPad, boolean shadow, long msVisible) {
    drawScrollingString(graphics, text, x, y, alignment, color, getXSize(), maxLengthPad, shadow, msVisible);
  }

  default void drawScrollingString(GuiGraphics graphics, Component text, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int width, int maxLengthPad, boolean shadow) {
  ...
  default void drawScrollingString(GuiGraphics graphics, Component text, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int width, int height, int maxLengthPad,
  ...
  default void drawScrollingString(GuiGraphics graphics, Component text, int minX, int minY, int maxX, int maxY, IFancyFontRenderer.TextAlignment alignment, int color, boolean shadow,
                                   long msVisible) {
    Font font = font();
  ...
  default void drawScaledScrollingString(GuiGraphics graphics, Component text, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int maxLengthPad, boolean shadow,
                                         float scale) {
  ...
  default void drawScaledScrollingString(GuiGraphics graphics, Component text, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int width, int maxLengthPad,
  ...
  default void drawScaledScrollingString(GuiGraphics graphics, Component text, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int width, int height, int maxLengthPad,
                                         boolean shadow, float scale, long msVisible) {
  ...
  default void drawScaledScrollingString(GuiGraphics graphics, Component text, int minX, int minY, int maxX, int maxY, IFancyFontRenderer.TextAlignment alignment, int color, boolean shadow,
                                         float scale, long msVisible) {
    if (scale == 1.0F) {
  ...
  class WrappedTextRenderer {
    ...
    public void render(GuiGraphics graphics, int x, int y, int maxLength, IFancyFontRenderer.TextAlignment alignment, int color) {
      render(graphics, x, y, maxLength, alignment, color, 1);
    }

    public int renderWithScale(GuiGraphics graphics, int x, int y, IFancyFontRenderer.TextAlignment alignment, int color, int maxLength, float scale) {
    ...
    private void render(GuiGraphics graphics, int x, int startY, int maxLength, IFancyFontRenderer.TextAlignment alignment, int color, float scale) {
  ...
  class ReplaceableWrappedTextRenderer extends IFancyFontRenderer.WrappedTextRenderer {

    public ReplaceableWrappedTextRenderer(IFancyFontRenderer parent, int width, Component text) {
      super(new IFancyFontRenderer.ReplaceableWrappedTextRenderer.SimpleFancyFontRenderer(parent.font(), width), text);
    }

    public IFancyFontRenderer.WrappedTextRenderer replaceFont(IFancyFontRenderer font) {
